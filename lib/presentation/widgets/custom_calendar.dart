            ...
            children: [
              ...
              GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  final bool isToday = currentDate.day == DateTime
                      .now()
                      .day &&
                      currentDate.month == DateTime
                          .now()
                          .month &&
                      currentDate.year == DateTime
                          .now()
                          .year;
                  ...
                  return GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //   height: 4,
                        //   decoration: BoxDecoration(
                        //     color: _selectedDate == state.eventList[index].dateTime ? Colors.blue : Colors.transparent,
